...
cube = Actor(position=(0, 0, 0), rotation=(0, 0, 0), mesh=cube_mesh, texture=blue_texture, collision=True, physic=True, mass=4)
...
# cube_2.apply_force(force=Vector3(0, 0, -10.0))
